...
function makeAbsolute(url: string, siteUrl: string): string {
...
function fixImagePaths(html: string, siteUrl: string): string {
...
function stripMDXComponents(text: string, siteUrl: string): string {
  return (
    text
